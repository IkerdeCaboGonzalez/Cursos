# -*- coding: utf-8 -*-
"""02-Visualization-Exercises.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1W71qejm5T7mp1nsmVjBsCiZ9Di3gBdMh
...
plt.scatter(x, y, alpha=0.2, edgecolor='blue')  # Set alpha and edgecolor
plt.ylabel('Price')
plt.xlabel('Carat')
plt.title('Scatter Plot of Price vs. Carat')
plt.show()
...
plt.xlabel('Cut')
plt.ylabel('Count')
plt.title('Count Plot of Cut Types')
plt.show()
...
plt.xlabel('Cut')
plt.ylabel('Price')
plt.title('Box Plot of Price Distribution per Cut Type')
...
my_palette = ['lightgreen', 'mediumseagreen', 'seagreen', 'darkseagreen', 'darkslategrey']

plt.figure(figsize=(10,6))
sns.boxplot(x='cut', y='price', data=diamonds, order=cut_order, palette=my_palette)
plt.xlabel('Cut')
plt.ylabel('Price')
plt.title('Box Plot of Price Distribution per Cut Type')
plt.show()
