...
Original file is located at
    https://colab.research.google.com/drive/17UjIk72MlNT6VN3Cwq_5I6wDXxZ3vxTo
...
# CODE HERE
data[data['inflation_annual_cpi']==data['inflation_annual_cpi'].max()]
...
# CODE HERE
año=data[(data['country']=='Kenya')&(data['systemic_crisis']==1)].sort_values('year').iloc[0]['year']
print(año)
...
# CODE HERE
data[data['systemic_crisis'] == 1].groupby('country').sum()['systemic_crisis']
...
data[data['country']=='Zimbabwe']#.sum()['sovereign_external_debt_default']
...
data[data['country']=='Algeria'].sort_values('exch_usd',ascending=False).iloc[0, ]
